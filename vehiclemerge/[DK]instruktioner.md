## Da jeg har set mange som har en resource for hver bil så vil jeg tilbyde denne guide så i kan samle alle jeres biler i en fil så det ser lidt bedre ud og serveren kører mere smooth :)
